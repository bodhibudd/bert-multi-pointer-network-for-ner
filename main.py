...
from bert_mpn.data_loader import Feature, Reader
from bert_mpn.train import Trainer
...
def get_args():
    ...
    parser.add_argument("--train_mode",type=str, default="resume")
    parser.add_argument("--train_batch_size", default=1,type=int)
    parser.add_argument("--learning_rate",default=5e-5,type=float)
    parser.add_argument("--epoch_num", default=30,type=int)
    parser.add_argument("--patient_stop",type=int,default=1000)
...
def build_dataset(args, reader, debug=False):
    ...
    dev_dataloader = dev_dataset.get_dataloader(args.train_batch_size, shuffle=False)
...
def main():
    ...
    trainer = Trainer(args, data_loader, eval_examples, MPN_ENTITY)
